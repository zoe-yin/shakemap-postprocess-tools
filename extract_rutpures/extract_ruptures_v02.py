...
fig.text(x=38, y=35.9, text="Avg. Aspect Ratio: " + str(round(avg_aspect,2)) ,font="20p,Helvetica,black")
fig.text(x=38, y=35.8, text=f"Avg. Fault length: {avg_fault_length:.2f} km" ,font="20p,Helvetica,black")
fig.text(x=38, y=35.7, text=f"Avg. updip depth: {avg_updip_depth:.2f} km" ,font="20p,Helvetica,black")
fig.text(x=38, y=35.6, text=f"Avg. downdip depth: {avg_downdip_depth:.2f} km" ,font="20p,Helvetica,black")
