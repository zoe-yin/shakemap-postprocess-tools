...
cd $eventpath
mkdir $eventpath/current_reproduction 
cp $eventpath/event.xml $eventpath/model.conf $eventpath/rupture.json $eventpath/current_reproduction/
ln -s $eventpath/current_reproduction $eventpath/current
